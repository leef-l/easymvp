...
export function useProjectState() {
  ...
  const routes = useMemo(
    () => ({
      ...
      requirements: buildRoute("/requirements"),
      design: buildRoute("/design"),
      review: buildRoute("/review"),
      plan: buildRoute("/plan"),
      execution: buildRoute("/execution"),
      replay: buildRoute("/replay"),
      acceptance: buildRoute("/acceptance"),
      delivery: buildRoute("/delivery"),
      retrospective: buildRoute("/retrospective"),
