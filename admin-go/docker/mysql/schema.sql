...
CREATE TABLE `mvp_workflow_event` (
  `id` bigint unsigned NOT NULL COMMENT '雪花ID',
  `event_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '事件元ID',
  `workflow_run_id` bigint unsigned NOT NULL COMMENT '所属工作流运行ID',
  `stage_run_id` bigint unsigned DEFAULT NULL COMMENT '关联阶段运行ID',
  ...
  `attempt` int NOT NULL DEFAULT '1' COMMENT '事件尝试次数',
  `idempotency_key` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '幂等键',
  `payload` json DEFAULT NULL COMMENT '事件载荷(JSON)',
  `created_at` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_workflow_event_event_id` (`event_id`),
  UNIQUE KEY `uk_workflow_event_idempotency_key` (`idempotency_key`),
...
CREATE TABLE `mvp_workflow_event_ledger` (
  `id` bigint unsigned NOT NULL COMMENT '雪花ID',
  `scope` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '账本作用域: workflow.publish / workflow.recovery.*',
  `event_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '事件元ID',
  `idempotency_key` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '幂等键',
  ...
  `status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '处理状态: handling/handled/failed',
  `last_error` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '最后一次错误',
...
-- Dump completed on 2026-04-12 11:20:08
