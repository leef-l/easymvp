...
CREATE TABLE `mvp_config` (
  ...
  KEY `idx_deleted_at` (`deleted_at`)
) ENGINE=InnoDB AUTO_INCREMENT=109 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='MVP配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mvp_config` (`id`, `config_key`, `config_value`, `config_type`, `category`, `description`, `created_by`, `dept_id`, `created_at`, `updated_at`, `deleted_at`) VALUES (1,'watchdog.check_interval','120','int','watchdog','心跳检测间隔（秒）',0,0,'2026-04-03 16:31:01','2026-04-03 16:31:01',NULL),(2,'watchdog.max_stale_count','3','int','watchdog','连续无进展次数阈值（超过则判定卡死）',0,0,'2026-04-03 16:31:01','2026-04-03 16:31:01',NULL),(3,'watchdog.max_retries','3','int','watchdog','最大自动重试次数（超过则升级给架构师）',0,0,'2026-04-03 16:31:01','2026-04-03 16:31:01',NULL),(4,'scheduler.max_concurrent','20','int','scheduler','最大并发任务数',0,0,'2026-04-03 16:31:01','2026-04-03 16:31:01',NULL),(5,'scheduler.poll_interval','2','int','scheduler','调度轮询间隔（秒）',0,0,'2026-04-03 16:31:01','2026-04-03 16:31:01',NULL),(6,'review.timeout_seconds','300','int','engine','方案审核阶段超时时间（秒），超时跳过AI审核',0,0,'2026-04-04 16:04:26','2026-04-04 16:04:26',NULL),(7,'review.auto_fix_batch','1','int','engine','预检时是否自动修正batch_no不合理的问题（1=是）',0,0,'2026-04-04 16:04:26','2026-04-04 16:04:26',NULL),(8,'accept.llm_judge_enabled','1','int','accept','LLM 质量评审开关：1=启用 0=禁用（禁用时退化为纯硬规则裁决）',0,0,'2026-04-05 21:13:13','2026-04-05 21:13:13',NULL),(9,'accept.manual_review_enabled','1','int','accept','人工审核开关：1=启用 0=禁用（禁用时 uncertain 决策自动转 passed）',0,0,'2026-04-05 21:13:13','2026-04-05 21:13:13',NULL),(10,'accept.llm_judge_project_types','*','string','accept','LLM Judge 启用的项目类型白名单（JSON 数组如 [\"software_dev\",\"game_dev\"]，* 或空表示全部启用）',0,0,'2026-04-05 21:33:17','2026-04-05 21:33:17',NULL),(11,'accept.manual_review_project_types','*','string','accept','人工审核启用的项目类型白名单（JSON 数组，* 或空表示全部启用）',0,0,'2026-04-05 21:33:17','2026-04-05 21:33:17',NULL),(12,'accept.project_types','*','string','accept','Accept 验收总开关的项目类型白名单（JSON 数组，* 或空表示全部启用）',0,0,'2026-04-05 21:33:17','2026-04-05 21:33:17',NULL),(13,'workflow.autonomy.enabled','0','autonomy','general','自治中台总开关（0=关闭, 1=开启）',0,0,'2026-04-05 22:32:39','2026-04-06 03:43:36',NULL),(14,'workflow.autonomy.audit_only','1','autonomy','general','仅审计模式（1=只写记录不执行, 0=正式接管）',0,0,'2026-04-05 22:32:39','2026-04-06 03:43:36',NULL),(15,'workflow.autonomy.policy_engine_enabled','1','autonomy','general','策略引擎开关',0,0,'2026-04-05 22:32:39','2026-04-06 03:43:36',NULL),(16,'workflow.autonomy.risk_gate_enabled','1','autonomy','general','风险闸门开关',0,0,'2026-04-05 22:32:39','2026-04-06 03:43:36',NULL),(25,'workflow.collab.feishu_enabled','0','int','collab','飞书通知总开关(0关/1开)',0,0,'2026-04-06 00:38:35','2026-04-06 03:43:36',NULL),(26,'workflow.collab.feishu_app_id','','string','collab','飞书应用 App ID',0,0,'2026-04-06 00:38:35','2026-04-06 03:43:36',NULL),(27,'workflow.collab.feishu_app_secret','','string','collab','飞书应用 App Secret',0,0,'2026-04-06 00:38:35','2026-04-06 03:43:36',NULL),(28,'workflow.collab.feishu_encrypt_key','','string','collab','飞书事件回调加密 Key(签名验证)',0,0,'2026-04-06 00:38:35','2026-04-06 03:43:36',NULL),(29,'workflow.collab.feishu_default_notify_user_ids','','string','collab','降级通知的系统用户ID列表(逗号分隔)',0,0,'2026-04-06 00:38:35','2026-04-06 03:43:36',NULL),(30,'workflow.autonomy.patrol_interval','60','int','autonomy','态势巡检间隔(秒)',0,0,'2026-04-06 03:36:41','2026-04-06 03:43:36',NULL),(31,'workflow.autonomy.patrol_enabled','0','int','autonomy','定时巡检开关(0关/1开)',0,0,'2026-04-06 03:36:41','2026-04-06 03:43:36',NULL),(32,'workflow.autonomy.objective_enabled','0','int','autonomy','目标层准入控制开关(0关/1开)',0,0,'2026-04-06 03:36:41','2026-04-06 03:43:36',NULL),(33,'workflow.autonomy.default_token_budget','0','int','autonomy','默认Token预算(0=不限)',0,0,'2026-04-06 03:36:41','2026-04-06 03:43:36',NULL),(34,'workflow.autonomy.default_time_budget_hours','0','string','autonomy','默认时间预算(小时,0=不限)',0,0,'2026-04-06 03:36:41','2026-04-06 03:43:36',NULL),(35,'workflow.autonomy.default_risk_tolerance','balanced','string','autonomy','默认风险容忍度(conservative/balanced/aggressive)',0,0,'2026-04-06 03:36:41','2026-04-06 03:43:36',NULL),(36,'workflow.autonomy.default_autonomy_level','supervised','string','autonomy','默认自治级别(manual/supervised/autonomous)',0,0,'2026-04-06 03:36:41','2026-04-06 03:43:36',NULL),(37,'workflow.autonomy.strategy_enabled','0','int','autonomy','策略函数总开关(0关/1开)',0,0,'2026-04-06 03:36:47','2026-04-06 03:43:37',NULL),(38,'workflow.autonomy.adaptive_retry_enabled','1','int','autonomy','自适应重试策略(0关/1开)',0,0,'2026-04-06 03:36:47','2026-04-06 03:43:37',NULL),(39,'workflow.autonomy.engine_selection_enabled','1','int','autonomy','执行器选择策略(0关/1开)',0,0,'2026-04-06 03:36:47','2026-04-06 03:43:37',NULL),(40,'workflow.autonomy.batch_adjust_enabled','1','int','autonomy','批次调整策略(0关/1开)',0,0,'2026-04-06 03:36:47','2026-04-06 03:43:37',NULL),(41,'workflow.autonomy.cost_guard_enabled','1','int','autonomy','成本守卫策略(0关/1开)',0,0,'2026-04-06 03:36:47','2026-04-06 03:43:37',NULL),(42,'workflow.autonomy.proactive_replan_enabled','1','int','autonomy','主动重规划策略(0关/1开)',0,0,'2026-04-06 03:36:47','2026-04-06 03:43:37',NULL),(43,'workflow.autonomy.quality_gate_enabled','1','int','autonomy','质量门策略(0关/1开)',0,0,'2026-04-06 03:36:47','2026-04-06 03:43:37',NULL),(106,'workflow.autonomy.meta_cognition_enabled','0','int','autonomy','元认知观测开关(0关/1开)',0,0,'2026-04-06 04:09:43','2026-04-06 04:09:43',NULL),(107,'workflow.autonomy.meta_auto_tune_enabled','0','int','autonomy','自动校准开关-保守方向(0关/1开)',0,0,'2026-04-06 04:09:43','2026-04-06 04:09:43',NULL),(108,'workflow.autonomy.learner_enabled','0','int','autonomy','EMA学习开关(0关/1开)',0,0,'2026-04-06 04:09:43','2026-04-06 04:09:43',NULL);
/*!40000 ALTER TABLE `mvp_config` ENABLE KEYS */;
UNLOCK TABLES;

LOCK TABLES `mvp_policy_rule` WRITE;
/*!40000 ALTER TABLE `mvp_policy_rule` DISABLE KEYS */;
INSERT INTO `mvp_policy_rule` (`id`, `rule_code`, `rule_name`, `decision_type`, `decision_level`, `trigger_source`, `project_family`, `project_category_code`, `config_json`, `enabled`, `priority`, `created_by`, `dept_id`, `created_at`, `updated_at`, `deleted_at`) VALUES (900000000000001,'POL_TASK_FAIL_RETRY','任务失败自动重试','task_recovery','A','task.failed',NULL,NULL,'{\"max_retry\": 3, \"action_type\": \"retry_task\"}',1,10,0,0,'2026-04-05 22:33:20','2026-04-06 03:43:36',NULL),(900000000000002,'POL_REWORK_DONE_ACCEPT','返工完成回验收','rework_flow','A','rework.completed',NULL,NULL,'{\"action_type\": \"rerun_accept\"}',1,10,0,0,'2026-04-05 22:33:20','2026-04-06 03:43:36',NULL),(900000000000003,'POL_RETRY_EXHAUST_REWORK','重试耗尽建议返工','task_recovery','B','task.retry_exhausted',NULL,NULL,'{\"action_type\": \"trigger_rework\"}',1,20,0,0,'2026-04-05 22:33:20','2026-04-06 03:43:36',NULL),(900000000000004,'POL_ACCEPT_FAIL_REWORK','验收失败建议返工','accept_flow','B','accept.failed',NULL,NULL,'{\"action_type\": \"trigger_rework\"}',1,20,0,0,'2026-04-05 22:33:20','2026-04-06 03:43:36',NULL),(900000000000005,'POL_ACCEPT_PASS_COMPLETE','验收通过建议完成','accept_flow','B','accept.passed',NULL,NULL,'{\"action_type\": \"approve_complete\"}',1,20,0,0,'2026-04-05 22:33:20','2026-04-06 03:43:36',NULL),(900000000000006,'POL_CIRCUIT_BREAK_PAUSE','熔断暂停','circuit_break','C','workflow.circuit_break',NULL,NULL,'{\"action_type\": \"pause_workflow\"}',1,30,0,0,'2026-04-05 22:33:20','2026-04-06 03:43:36',NULL),(900000000000007,'POL_ACCEPT_MANUAL','验收人工审核','accept_flow','C','accept.manual_review',NULL,NULL,'{\"action_type\": \"notify_human\"}',1,30,0,0,'2026-04-05 22:33:20','2026-04-06 03:43:36',NULL),(900000000000008,'POL_REPLAN_SUGGEST','重规划建议','replan','C','replan.suggested',NULL,NULL,'{\"action_type\": \"replan_workflow\"}',1,30,0,0,'2026-04-05 22:33:20','2026-04-06 03:43:36',NULL);
/*!40000 ALTER TABLE `mvp_policy_rule` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `mvp_risk_gate_rule` WRITE;
/*!40000 ALTER TABLE `mvp_risk_gate_rule` DISABLE KEYS */;
INSERT INTO `mvp_risk_gate_rule` (`id`, `gate_code`, `gate_name`, `gate_type`, `project_family`, `project_category_code`, `trigger_expression`, `block_action`, `fallback_action`, `enabled`, `priority`, `created_by`, `dept_id`, `created_at`, `updated_at`, `deleted_at`) VALUES (900000000000101,'GATE_RUNTIME_FAIL_LIMIT','连续失败上限闸门','runtime',NULL,NULL,'{\"trigger_source\": \"task.failed\", \"min_failure_count\": 10}','pause_workflow','notify_human',1,10,0,0,'2026-04-05 22:33:20','2026-04-06 03:43:36',NULL),(900000000000102,'GATE_QUALITY_REWORK_LIMIT','返工轮次上限闸门','quality',NULL,NULL,'{\"trigger_source\": \"rework.completed\", \"max_rework_rounds\": 5}','pause_workflow','notify_human',1,20,0,0,'2026-04-05 22:33:20','2026-04-06 03:43:36',NULL),(900000000000103,'GATE_COST_ACCEPT_LIMIT','验收轮次上限闸门','cost',NULL,NULL,'{\"trigger_source\": \"accept.failed\", \"max_accept_rounds\": 5}','pause_workflow','notify_human',1,30,0,0,'2026-04-05 22:33:20','2026-04-06 03:43:36',NULL);
/*!40000 ALTER TABLE `mvp_risk_gate_rule` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `system_role_ai_engine` (`role_id`, `engine_code`) VALUES (1000000000000000002,'aider'),(1000000000000000002,'openhands');
