...
type AiProvider struct {
	...
	ProviderType       string      `orm:"provider_type" description:"供应商主类型/默认路由类型"`                                                                         // 供应商主类型/默认路由类型
	SupportedProtocols string      `orm:"supported_protocols" description:"支持的协议类型(JSON)：anthropic/openai_compatible/google 等"`                              // 支持的协议类型(JSON)：anthropic/openai_compatible/google 等
