...
type MvpMessage struct {
	...
	MessageType    string      `orm:"message_type"    description:"消息类型：chat_user/chat_reply/task_prompt/task_reply/system_notice/poison/general"` // 消息类型：chat_user/chat_reply/task_prompt/task_reply/system_notice/poison/general
