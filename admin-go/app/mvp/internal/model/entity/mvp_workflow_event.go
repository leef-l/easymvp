...
type MvpWorkflowEvent struct {
	...
	EventId        string      `orm:"event_id"        description:"事件元ID"`                                                              // 事件元ID
	...
	Attempt        int         `orm:"attempt"         description:"事件尝试次数"`                                                             // 事件尝试次数
	IdempotencyKey string      `orm:"idempotency_key" description:"幂等键"`                                                                // 幂等键
