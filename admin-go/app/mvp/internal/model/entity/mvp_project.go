...
type MvpProject struct {
	...
	ObjectiveJson       string      `orm:"objective_json"         description:"项目目标约束(JSON): budget/deadline/risk_tolerance/autonomy_level"` // 项目目标约束(JSON): budget/deadline/risk_tolerance/autonomy_level
