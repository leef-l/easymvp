...
--
-- Dumping data for table `ai_engine`
--

LOCK TABLES `ai_engine` WRITE;
/*!40000 ALTER TABLE `ai_engine` DISABLE KEYS */;
INSERT INTO `ai_engine` VALUES (1000000000000001001,'aider','Aider','本地命令行代码执行引擎',1,10,1,0,'2026-04-03 10:54:32','2026-04-03 10:54:32',NULL),(1000000000000001002,'openhands','OpenHands','远程Agent执行引擎',1,20,1,0,'2026-04-03 10:54:32','2026-04-03 10:54:32',NULL);
...
INSERT INTO `ai_plan` VALUES (315057243017973760,315056637784100864,'零落coding plan pro','hunyuan-coding-plan-pro','sk-sp-ErlXWrTOnFVKB4kNZkJcyN6mHnLBn5d9nyVS8e0QmS4eoYih','',1,0,1000000000000000003,1000000000000000001,'2026-04-02 07:38:20','2026-04-02 07:38:20',NULL);
...
INSERT INTO `ai_provider` VALUES (315056637784100864,'腾讯云coding plan','anthropic','anthropic','https://api.lkeap.cloud.tencent.com/coding/anthropic/v1','ant-design:wechat-filled',1,0,1000000000000000003,1000000000000000001,'2026-04-02 07:35:56','2026-04-02 15:41:36',NULL);
...
--
-- Dumping data for table `mvp_task_resource_lock`
--

LOCK TABLES `mvp_task_resource_lock` WRITE;
/*!40000 ALTER TABLE `mvp_task_resource_lock` DISABLE KEYS */;
/*!40000 ALTER TABLE `mvp_task_resource_lock` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `system_role` VALUES (1000000000000000002,0,'超级管理员',1,1,0,1,'openhands',0,1000000000000000001,'2026-03-30 21:20:22','2026-04-01 11:55:43',NULL);
...
--
-- Dumping routines for database 'easymvp'
--
...
-- Dump completed on 2026-04-05 14:57:42
-- MySQL dump 10.13  Distrib 8.0.45, for Linux (x86_64)
--
-- Host: 127.0.0.1    Database: easymvp
-- ------------------------------------------------------
